...
def get_news(query, num=15):
    ...
    # ТЕСТОВАЯ ВЕРСИЯ: ограничено до 5 запросов
    queries = [
        query,
        "e-grocery Россия",
    ...
    # Полный список запросов (закомментирован для тестирования)
    # queries = [
    #     query,
    #     "e-grocery Россия",
    #     "доставка продуктов онлайн Россия",
    ...
    # ТЕСТ: комбинированный запрос закомментирован для ограничения количества запросов
    # combined_query = (
...
def generate_report(news_text):
    prompt = f"""
Ты — AI-ассистент-ресёрчер. Подготовь обзор по рынку e-grocery в России.
